...
from Environment.Model.DDPG_feature_reinfoce import Waveglider
...
class Actor(object):
    ...
    def saver(self, step):
        ...
        saver.save(self.sess, 'C:\\Users\\user\\PycharmProjects\\waveglider_RL\\Environment\\data\\Strategy14\\Mymodel', global_step= step)
###############################  Critic  ####################################
...
success = 0
t1 = time.time()
totalreward_save = 'C:\\Users\\user\\PycharmProjects\\waveglider_RL\\Environment\\data\\Strategy14\\totalreward.json'
...
for i in range(MAX_EPISODES):
    ...
    while True:
        ...
        if ep_reward > 2000 and step % 5 == 0:
            env.render()
        ...
        s = s_
        ep_reward += r
        # print(env.obstacle, [env.state_0.item(0), env.state_0.item(1)], s[2])
        if done:
            break
        step += 1
    ...
    print('Episode:', i, ',', 'Reach:', success, ',', 'Step:', step, ',', 'Explore:', var, ',', 'Reward:', ep_reward, 'obstacle:', env.obstacle, env.obst_R)
